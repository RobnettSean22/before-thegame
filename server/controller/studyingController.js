module.exports = {
    ...
    updateFolderStudying : (req, res, next) => {
        ...
        db.update_to_studying([folder_id, studying_name]).then((studying) => res.status(200).send(studying)).catch(err => {
    ...
    deleteFolderStudying : (req, res, next) => {
        ...
        db.delete_studying(studying_id, folder_id).then((studying) => res.status(200).send(studying)).catch(err => {
