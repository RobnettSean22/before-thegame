...
class Header extends Component {
    ...
    render() {
        let button;
            this.props.user.user ? button = <NavLink className = 'direct' activeClassName = 'active' to = '/' onClick ={(e) => this.logout()} >Logout</NavLink>
            : button = <NavLink className = 'direct' activeClassName = 'active' to = '/login'>Login</NavLink> 
        return (
            <div>
